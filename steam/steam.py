...
class steam:
    ...
    async def rules(self, ctx):
        embed = Embed(title="**RULES**", color=0x000000)
    ...
    async def rank(self, ctx):
        embed = Embed(title="**https://baited.xyz/rankme**", url="https://baited.xyz/rankme", description="or https://baited.xyz/rankmena for na rankings.", color=0x000000)
    ...
    async def apply(self, ctx):
        embed=Embed(title="https://www.baited.xyz/dashboard/dash.php?apply", url="https://www.baited.xyz/dashboard/dash.php?apply", color=0x000000)
